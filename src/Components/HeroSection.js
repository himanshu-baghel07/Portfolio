...
const HeroSection = () => {
    ...
    return (
        <div id='heroSection'>
            ...
            >
         <style>
  @import url('https://fonts.googleapis.com/css2?family=Lora&family=Noto+Sans+Miao&family=Ubuntu&display=swap');
</style>
                <Box
                    sx={{
                        height: { md: '70vh', xs: '100vh',sm:'70vh' },
                ...
                >
                    <Card sx={{ backgroundColor: 'transparent', pointerEvents: 'none',marginBottom:'20px' }} elevation={0}>
                    ...
                    <Card
                        sx={{ width: '400px', height: '300px', backgroundColor: 'transparent' ,}}
                        elevation={0} >
                        <CardContent>
                            <Typography
                                sx={{
